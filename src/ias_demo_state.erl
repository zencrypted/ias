...
summary() ->
    ...
    #{objects => length(DomainObjects),
      ...
      projection_hash_algorithm => maps:get(projection_hash_algorithm,
                                            Projection,
                                            undefined),
      durable_projection_hash => maps:get(durable_projection_hash,
                                          Projection,
                                          undefined),
      ets_projection_hash => maps:get(ets_projection_hash,
                                      Projection,
                                      undefined),
