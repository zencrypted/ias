...
certificate_demo_object(Enrollment) ->
    ...
    #{id => ias_html:join([ImportId, <<"_certificate">>]),
      ...
      certificate_public_key_fingerprint => maps:get(certificate_public_key_fingerprint, Enrollment, undefined),
      private_key_reference => maps:get(private_key_reference, Enrollment, undefined),
      key_rotation => maps:get(key_rotation, Enrollment, undefined),
